...
// NodeConfig represents an abstract node interface for the configuration
...
// NodeConfigEqual returns true if the other node is same with this node
func NodeConfigEqual(this, other NodeConfig) bool {
