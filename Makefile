...
PACKAGES=${PACKAGE_ID} ${PACKAGE_ID}/log ${PACKAGE_ID}/errors ${PACKAGE_ID}/registry ${PACKAGE_ID}/metric ${PACKAGE_ID}/register ${PACKAGE_ID}/action ${PACKAGE_ID}/kb ${PACKAGE_ID}/qos ${PACKAGE_ID}/fql
